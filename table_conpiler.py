...
for x in var:
    constructed_dict = {
        "model": "src.AnnouncedPollingUnitResult",
        "pk": count,
        "fields": {
            "result_id": x[0],
            "polling_unit_unique_id": x[1],
            "party_abbreviation": x[2],
            "party_score": x[3],
            "entered_by_user": x[4],
            "date_entered": x[5],
            "user_ip_address": x[6]
    ...
    my_list.append(constructed_dict)
    count += 1
count = 1
with open('src/fixtures/announced_pu_results.json', 'w') as file:
    file.write(str(my_list).replace("'", "\""))
...
pu_list = []
for x in polling_units:
    constructed_dict = {
        "model": "src.PollingUnit",
        "pk": count,
        "fields": {
            "unique_id": x[0],
            "polling_unit_id": x[1],
            ...
            "lga_id": x[3],
            "unique_ward_id": x[4],
            "polling_unit_number": x[5],
            "polling_unit_name": x[6],
            "polling_unit_description": x[7],
            "lat": x[8],
            "long": x[9],
            "entered_by_user": x[10],
            "date_entered": '2011-04-26 15:44:03',
            "user_ip_address": x[12],
        }
    }
    pu_list.append(constructed_dict)
    count += 1
count = 1
with open('src/fixtures/polling_units.json', 'w') as file:
    file.write(str(pu_list).replace("'", "\""))
...
for x in lga:
    ...
    lga_list.append(constructed_dict)
    count += 1
count = 1
with open('src/fixtures/lga.json', 'w') as file:
    file.write(str(lga_list).replace("'", "\""))


announced_lga_result = [
...
announced_lga_result_list = []
for x in announced_lga_result:
    constructed_dict = {
        "model": "src.AnnouncedLgaResult",
        "pk": count,
        "fields": {
            "result_id": x[0],
            "lga_name": x[1],
    ...
    announced_lga_result_list.append(constructed_dict)
    count += 1
count = 1
with open('src/fixtures/announced_lga_result_list.json', 'w') as file:
    file.write(str(announced_lga_result_list).replace("'", "\""))
...
for x in party:
    ...
    party_list.append(constructed_dict)
    count += 1
count = 1
with open('src/fixtures/party_list.json', 'w') as file:
    file.write(str(party_list).replace("'", "\""))
